        ...
        <div class="container">
         ...
         <div class="collapse navbar-collapse" id="Navbar">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item"><a class="nav-link" href="{{ url('') }}"><span class="fa fa-home fa-lg"> Home</span></a></li>
                <li class="nav-item active"><a class="nav-link" href="{{ url('/about') }}"><span class="fa fa-info fa-lg"> About</span></a></li>
            ...
            <div class="col-12">
                <div class="card card-body bg-light">
                    <blockquote class="blockquote">
                        <p class="mb-0">You better cut the pizza in four pieces becauseI'm not hungry enough to eat six.</p>
            ...
            <div class="col-12">
                ...
                <div id="accordion">
                    <div class="card">
                        ...
                        <div id="peter" class="collapse show" role="tabpanel" data-parent="#accordion">
                            <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="dannyhead">
                            <h3 class="mt-0">
                               <a href="" data-toggle="collapse" data-target="#danny">
                                Dhanasekaran Witherspoon <small>Chief Food Officer</small></h3>
                               </a>
                        </div>
                        <div id="danny" class="collapse" role="tabpanel" data-parent="#accordion">
                            <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="agumbehead">
                            <h3 class="mt-0">
                               <a href="" data-toggle="collapse" data-target="#agumbe">
                                Agumbe Tang <small>Chief Taste Officer</small></h3>
                               </a>
                        </div>
                        <div id="agumbe" class="collapse" role="tabpanel" data-parent="#accordion">
                            <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div id="alberto" class="collapse" role="tabpanel" data-parent="#accordion">
                            <div class="card-body">
